<template>
  <div class="footer">
    ...
    <div class="beian">
      <a
        href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=36090202000125"
        class="link"
      >
        <img class="beian-logo" src="../assets/beian_logo.png" />
        <div>赣公网安备 36090202000125号</div>
      </a>
    </div>
  </div>
</template>
